...
BEGIN_EVENT_TABLE(treesheets::TSCanvas, wxScrolledWindow)
  ...
  EVT_CHAR_HOOK(treesheets::TSCanvas::OnCharHook)
  EVT_CHAR(treesheets::TSCanvas::OnChar)
  EVT_KEY_DOWN(treesheets::TSCanvas::OnKeyDown)
  EVT_KEY_UP(treesheets::TSCanvas::OnKeyUp)
  EVT_KILL_FOCUS(treesheets::TSCanvas::OnKillFocus)
  EVT_MOUSE_CAPTURE_LOST(treesheets::TSCanvas::OnMouseCaptureLost)
  EVT_SET_CURSOR(treesheets::TSCanvas::OnSetCursor)
